...
const greeting = {
  ...
  subTitle: emoji(
    "A passionate Full Stack Software Developer 🚀 having an experience of building Web applications with JavaScript / Reactjs / Nodejs and some other cool libraries and frameworks and also interested in Machine Learning"
  ),
  resumeLink:
...
const skillsSection = {
  ...
  skills: [
    ...
    emoji(
      "⚡ Integrate Backend and Databases wherever required"
    ),
    emoji(
      "⚡Integrating the Best Machine Learning model for getting the best results"
    ),
    emoji(
      "⚡ Competitive Programming to sharpen my thinking and logical abilities"
    ),
    emoji(
      "⚡Continously learning new skills and looking for opportunities"
    ),
  ],
